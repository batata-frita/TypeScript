namespace ts {
    ...
    function getExtendsConfigPath(
        ...
        const resolved = nodeModuleNameResolver(Extension.Ts, extendedConfig, combinePaths(basePath, "tsconfig.json"), { moduleResolution: ModuleResolutionKind.NodeJs }, host, /*cache*/ undefined, /*projectRefs*/ undefined, /*lookupConfig*/ true);
